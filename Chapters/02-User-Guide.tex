...
\multirow[t]{2}{*}{\footnotesize{\textit{eniad, esecs, esslei, esad, estm}}} & \footnotesize{\textit{$\Rightarrow$ Default: school=eniad}} \\
...
\footnotesize{\textit{french, english}} & \footnotesize{\textit{$\Rightarrow$ Default: language=english}} \\[0.85em]
